...
## 📊 إحصائيات الخدمات الحكومية (Data Benchmark)

> بيانات من منصة أبشر الرسمية

| اسم الخدمة                               | إجمالي التعاملات | نسبة الرقمية | نسبة الإتمام | رضى المستخدمين |
| ---------------------------------------- | ---------------- | ------------ | ------------ | -------------- |
| التحقق من الهوية الرقمية                 | 6,236,277        | 100%         | 99%          | 80%            |
| الاعتراض على المخالفات المرورية - اعتراض | 3,405,415        | 100%         | 100%         | 80%            |
| تجديد الإقامة                            | 3,164,779        | 88%          | 90%          | 80%            |
| تأشيرة خروج وعودة - إصدار                | 2,888,116        | 89%          | 92%          | 80%            |
| تجديد رخصة السير                         | 917,977          | 97%          | 90%          | 80%            |
| تمديد تأشيرة الزيارة                     | 749,163          | 100%         | 100%         | 80%            |
| إصدار إذن إصلاح المركبة                  | 645,724          | 98%          | 87%          | 80%            |
| إصدار جواز السفر الإلكتروني              | 635,092          | 100%         | 100%         | 80%            |
| إصدار الإقامة                            | 633,349          | 98%          | 90%          | 80%            |
| خدمة تقارير أبشر                         | 563,360          | 100%         | 99%          | 80%            |
| تفويض القيادة                            | 444,195          | 98%          | 92%          | 80%            |
| تجديد رخصة القيادة                       | 420,429          | 98%          | 80%          | 80%            |
| توصيل الوثائق                            | 407,872          | 100%         | 98%          | 80%            |
| تصاريح السفر - التابعين                  | 367,975          | 100%         | 97%          | 80%            |

### 📋 إحصائيات ردود الزوار

| المؤشر                  | العدد     | النسبة |
| ----------------------- | --------- | ------ |
| إجمالي الصفحات المقيّمة | 1,286,333 | 100%   |
| ✅ نعم (استفدت)         | 916,206   | 71%    |
| ❌ لا (لم أستفد)        | 370,127   | 29%    |

### ✅ تفاصيل نعم - لماذا استفدت؟

| السبب                                | العدد   |
| ------------------------------------ | ------- |
| وجدت الصفحة مفيدة و واضحة            | 701,317 |
| تمكنت من الوصول الى المعلومات بسهولة | 335,382 |
| تصفح الصفحة مريح و سهل               | 277,201 |
| صياغة المحتوى متقن في هذه الصفحة     | 234,812 |
| أسباب أخرى                           | 40,813  |

### ❌ تفاصيل لا - لماذا لم تستفد؟

| السبب                                           | العدد   |
| ----------------------------------------------- | ------- |
| لم أتمكن من إيجاد المعلومات المراد الحصول عليها | 194,886 |
| المحتوى غير مفهوم                               | 147,141 |
| واجهتني مشكلة تقنية                             | 62,877  |
| وجدت صعوبة في القراءة عند تصفح هذه الصفحة       | 31,724  |
| أسباب أخرى                                      | 17,778  |

### 💡 كيف يحل عون هذه المشاكل؟

| المشكلة                      | حل عون                                  |
| ---------------------------- | --------------------------------------- |
| لم يجدوا المعلومات (194,886) | 🔍 بحث بالعامية + فهم السياق            |
| محتوى غير مفهوم (147,141)    | 💬 شرح تفاعلي بلغة بسيطة                |
| مشاكل تقنية (62,877)         | 🤖 واجهة ذكية + نماذج معبأة تلقائياً    |
| صفحات مساعدة سيئة (9-30%)    | 🎤 محادثة ذكية بدلاً من الأسئلة الشائعة |

### ⚠️ الخدمات الأقل تقييماً

| الخدمة                                    | عدد التقييمات | التقييم |
| ----------------------------------------- | ------------- | ------- |
| الاعتراض على المخالفات المرورية           | 14,384        | 60%     |
| الاستعلام عن رصيد مدفوعات الخدمات المتبقي | 2,596         | 60%     |
| إلغاء تصريح الحج بواسطة الحاج             | 1,400         | 60%     |
| تواصل (المرور)                            | 861           | 60%     |
| الإبلاغ عن شهادة وفاة مفقودة              | 145           | 60%     |
...
| المصدر                | الرابط                                                                                                                                                                                                                                                                                                                                                                       |
| --------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **منصة أبشر الرسمية** | [absher.sa](https://www.absher.sa/wps/portal/individuals/static/footer/sp/!ut/p/z1/jY_BCoJAFEW_xq3vzYg2tBtFRkqItMhmExY2GubEaPr7Wa0Ci97uXs658EBCBrLJ-0rlXaWbvB7zXnoHj8YBiRhdspS76AWbkEWhSzHwYPcCBCE8ogJjIRKK64ATZ8Z9wogL8h__B_D08ctxHH05gXD0E-o7iGJFJ4GPjQVIVevj-13eHB2mQJriXJjC2Hcz1mXX3dq5hRYOw2ArrVVd2Cd9tXBKKXXbQfZJQpobuF23GV7cuo_P_AF8ELFC/dz/d5/L2dBISEvZ0FBIS9nQSEh/) |
